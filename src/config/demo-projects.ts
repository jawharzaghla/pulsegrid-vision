...
export const FREE_PROJECT: Project = {
  ...
  name: 'Suivi du marché crypto',
  description: 'Veille en temps réel sur le marché des cryptomonnaies, avec les données en direct de CoinGecko',
  emoji: '📊',
  accentColor: '#7B2FBE',
  theme: { mode: 'dark', chartPalette: 'default', fontSize: 'comfortable', widgetBorder: 'card' },
  widgets: [
    makeWidget('w-free-btc', 'demo-free-crypto', 'Cours du Bitcoin',
      'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd&include_24hr_change=true',
      'kpi-card', 'coingecko-simple-price', 'bitcoin', '#F7931A'),
    makeWidget('w-free-eth', 'demo-free-crypto', "Cours de l'Ethereum",
      'https://api.coingecko.com/api/v3/simple/price?ids=ethereum&vs_currencies=usd&include_24hr_change=true',
      'kpi-card', 'coingecko-simple-price', 'ethereum', '#627EEA'),
    makeWidget('w-free-mcap', 'demo-free-crypto', 'Répartition de la capitalisation',
    ...
    makeWidget('w-free-trend', 'demo-free-crypto', 'Tendance BTC sur 7 jours',
      'https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=usd&days=7',
      'line-chart', 'coingecko-market-chart', '', '#F59E0B'),
    makeWidget('w-free-vol', 'demo-free-crypto', "Volume d'échanges sur 24 h",
...
const PRO_WEATHER: Project = {
  ...
  userId: 'demo-user-pro',
  name: 'Analyse météo',
  description: 'Suivi météo mondial, propulsé par Open-Meteo',
  emoji: '🌤️',
  accentColor: '#F59E0B',
  theme: { mode: 'dark', chartPalette: 'default', fontSize: 'comfortable', widgetBorder: 'card' },
  widgets: [
    makeWidget('w-pro-wtemp', 'demo-pro-weather', 'Température à Paris',
    ...
    makeWidget('w-pro-whourly', 'demo-pro-weather', 'Prévisions horaires',
    ...
    makeWidget('w-pro-wcities', 'demo-pro-weather', 'Températures mondiales',
      'https://api.open-meteo.com/v1/forecast?latitude=48.8566&longitude=2.3522&current_weather=true',
...
const PRO_WORLD: Project = {
  id: 'demo-pro-world',
  userId: 'demo-user-pro',
  name: 'Explorateur de données mondiales',
  description: "Statistiques par pays et démographie mondiale, depuis l'API REST Countries",
  emoji: '🌍',
  accentColor: '#22C55E',
  theme: { mode: 'dark', chartPalette: 'default', fontSize: 'comfortable', widgetBorder: 'card' },
  widgets: [
    makeWidget('w-pro-pop', 'demo-pro-world', 'Population mondiale',
      'https://restcountries.com/v3.1/all?fields=name,population,region,area',
      'kpi-card', 'restcountries-population', '', '#22C55E'),
    makeWidget('w-pro-count', 'demo-pro-world', 'Nombre de pays',
      'https://restcountries.com/v3.1/all?fields=name',
      'kpi-card', 'restcountries-count', '', '#7B2FBE'),
    makeWidget('w-pro-region', 'demo-pro-world', 'Population par région',
      'https://restcountries.com/v3.1/all?fields=name,population,region,area',
      'donut-chart', 'restcountries-region-donut', '', '#3498DB'),
    makeWidget('w-pro-area', 'demo-pro-world', 'Plus grands pays par superficie',
      'https://restcountries.com/v3.1/all?fields=name,population,region,area',
