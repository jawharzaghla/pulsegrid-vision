      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md glass rounded-2xl p-8 card-shadow">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg transition-all"
            >
              Sign In
            </button>
          </form>
          ...
          <button className="w-full py-2.5 border border-border hover:border-primary/50 rounded-lg text-body font-medium transition-all flex items-center justify-center gap-2">
